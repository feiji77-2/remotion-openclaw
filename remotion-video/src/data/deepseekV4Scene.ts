...
export const DEEPSEEK_V4_SCENE: UltimateProjectConfig = {
  title: 'DeepSeek V4 — 技术深挖',
  defaultPlatformOverlay: {
    brand: 'OpenClaw',
    account: '@deepseek_v4',
    searchLabel: 'DeepSeek V4 技术深挖',
    watermark: '1920x1080',
  },
  defaultTransition: {
    preset: 'lift',
  ...
  scenes: [
    /* @ts-ignore */
    {
      ...
      data: {
        ...
        badge: "BENCHMARK FIRST",
        accent: 'cyan',
        visualStyle: 'morfeo',
        tag: 'DeepSeek / V4 / 技术分析',
        tagEmoji: '📊',
        heroEmoji: '📊',
        highlightedWord: 'Benchmark',
        lines: [
    ...
    /* @ts-ignore */
    {
      ...
      data: {
        kicker: 'DeepSeek V4',
        heading: 'Benchmark 全面领先',
        summary: "三项全部刷新、全面超越前代",
        accent: 'cyan',
        bars: [
          { label: 'MMLU', value: 89.7, suffix: '%', accent: 'cyan' },
          { label: 'MATH', value: 96.2, suffix: '%', accent: 'green' },
          { label: 'HumanEval', value: 91.5, suffix: '%', accent: 'purple' },
          { label: 'GSM8K', value: 95.8, suffix: '%', accent: 'cyan' },
        ],
      },
    },
    /* @ts-ignore */
