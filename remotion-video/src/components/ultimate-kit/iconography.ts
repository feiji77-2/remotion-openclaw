...
const FAMILY_FALLBACK_ORDER: Record<UltimateSceneFamilyKey, UltimateIconName[]> = {
  hero: ['sparkles', 'code', 'flame'],
  'feature-rail': ['layers', 'box', 'user'],
  focus: ['layers', 'sparkles', 'home'],
  'number-strip': ['list', 'clock', 'zap'],
  'step-flow': ['list', 'toggleRight', 'inbox'],
  timeline: ['clock', 'gitBranch', 'repeat'],
  'compare-board': ['layoutDashboard', 'checkCircle', 'code'],
  terminal: ['terminal', 'server', 'code'],
  'evidence-wall': ['fileText', 'checkCircle', 'messagesSquare'],
  'architecture-map': ['layers', 'cpu', 'database'],
  'tag-matrix': ['layers', 'database', 'list'],
  code: ['code', 'terminal', 'gitBranch'],
  metrics: ['clock', 'zap', 'layoutDashboard'],
  'data-stream': ['zap', 'layoutDashboard', 'database'],
  'memory-graph': ['database', 'layers', 'cpu'],
  'pipeline-flow': ['arrowRight', 'gitMerge', 'repeat'],
  'benchmark-chart': ['layoutDashboard', 'clock', 'checkCircle'],
  'quote-highlight': ['messagesSquare', 'sparkles', 'fileText'],
  'glossary-term': ['fileText', 'layers', 'sparkles'],
  cta: ['messagesSquare', 'sparkles', 'save'],
};
