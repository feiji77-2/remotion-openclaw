...
export const UltimateFocusDiagram: React.FC<UltimateFocusDiagramProps & {grammar?: UltimateSceneGrammar}> = ({
  ...
  return (
    ...
    >
      <div style={{display: 'grid', gap: 16, maxWidth: 420, alignSelf: 'center'}}>
        {eyebrow ? <div style={{fontSize: 16, letterSpacing: 4, textTransform: 'uppercase', color}}>{eyebrow}</div> : null}
        {question ? (
