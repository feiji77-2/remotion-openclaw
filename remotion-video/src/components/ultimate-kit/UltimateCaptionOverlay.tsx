    ...
    >
      <div
        style={{
          ...
          borderRadius: 28,
          background: 'linear-gradient(180deg, rgba(10, 14, 24, 0.84) 0%, rgba(6, 8, 14, 0.92) 100%)',
          border: '1px solid rgba(205,255,61,0.22)',
          boxShadow: '0 24px 90px rgba(0,0,0,0.38), 0 0 40px rgba(205,255,61,0.08)',
            ...
            return (
              <span
                ...
                style={{
                  ...
                  padding: isActive ? '0.04em 0.16em 0.08em' : '0',
                  borderRadius: 14,
                  color: isActive ? '#07110a' : isPast ? '#f7fbff' : 'rgba(247,251,255,0.54)',
                  background: isActive ? '#39E508' : 'transparent',
                  boxShadow: isActive ? '0 0 24px rgba(57,229,8,0.28)' : 'none',
