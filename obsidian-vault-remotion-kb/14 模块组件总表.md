...
![[Assets/family-gallery/hero.png|420]]
![[Assets/family-gallery/focus.png|420]]
...
![[Assets/family-gallery/feature-rail.png|420]]
![[Assets/family-gallery/compare-board.png|420]]
...
![[Assets/family-gallery/terminal.png|420]]
![[Assets/family-gallery/architecture-map.png|420]]
...
![[Assets/family-gallery/data-stream.png|420]]
![[Assets/family-gallery/benchmark-chart.png|420]]
...
|---|---|---|---|---|
| `hero` | `UltimateHeroPanel.tsx` | `title` + `visual.props.lines` | [[Families/hero]] | [[16 图片图库#hero]] |
| `focus` | `UltimateFocusDiagram.tsx` | `visual.props.keyword` + `description` | [[Families/focus]] | [[16 图片图库#focus]] |
| `quote-highlight` | `UltimateQuoteHighlight.tsx` | `narration` + `visual.props.attribution` | [[Families/quote-highlight]] | [[16 图片图库#quote-highlight]] |
| `glossary-term` | `UltimateGlossaryTerm.tsx` | `visual.props.term` + `narration` | [[Families/glossary-term]] | [[16 图片图库#glossary-term]] |
| `cta` | `UltimateCtaPanel.tsx` | `title` + `narration` | [[Families/cta]] | [[16 图片图库#cta]] |

### 叙事表达区

| Family | React 组件 | 最先喂什么字段 | 详情 | 图 |
|---|---|---|---|---|
| `feature-rail` | `UltimateFeatureCardRail.tsx` | `features[]` | [[Families/feature-rail]] | [[16 图片图库#feature-rail]] |
| `number-strip` | `UltimateNumberStrip.tsx` | `visual.props.count` + `items[]` | [[Families/number-strip]] | [[16 图片图库#number-strip]] |
| `step-flow` | `UltimateStepFlow.tsx` | `items[]` | [[Families/step-flow]] | [[16 图片图库#step-flow]] |
| `timeline` | `UltimateTimeline.tsx` | `items[]` | [[Families/timeline]] | [[16 图片图库#timeline]] |
| `compare-board` | `UltimateCompareBoard.tsx` | `comparisons[]` + `dataPoints[]` | [[Families/compare-board]] | [[16 图片图库#compare-board]] |

### 系统证据区

| Family | React 组件 | 最先喂什么字段 | 详情 | 图 |
|---|---|---|---|---|
| `terminal` | `UltimateTerminalPanel.tsx` | `visual.props.command` + `outputs[]` | [[Families/terminal]] | [[16 图片图库#terminal]] |
| `evidence-wall` | `UltimateEvidenceWall.tsx` | `comparisons[]` | [[Families/evidence-wall]] | [[16 图片图库#evidence-wall]] |
| `architecture-map` | `UltimateArchitectureMap.tsx` | `items[]` + `visual.props.centerTitle` | [[Families/architecture-map]] | [[16 图片图库#architecture-map]] |
| `memory-graph` | `UltimateMemoryGraph.tsx` | `items[]` + `centerTitle` | [[Families/memory-graph]] | [[16 图片图库#memory-graph]] |
| `pipeline-flow` | `UltimatePipelineFlow.tsx` | `items[]` | [[Families/pipeline-flow]] | [[16 图片图库#pipeline-flow]] |

### 数据摘要区

| Family | React 组件 | 最先喂什么字段 | 详情 | 图 |
|---|---|---|---|---|
| `tag-matrix` | `UltimateTagMatrix.tsx` | `visual.props.tabs` + `items[]` | [[Families/tag-matrix]] | [[16 图片图库#tag-matrix]] |
| `metrics` | `UltimateMetricBars.tsx` | `dataPoints[]` 形如 `标签:值:ratio` | [[Families/metrics]] | [[16 图片图库#metrics]] |
| `data-stream` | `UltimateDataStream.tsx` | `dataPoints[]` 形如 `标签:值` | [[Families/data-stream]] | [[16 图片图库#data-stream]] |
| `benchmark-chart` | `UltimateBenchmarkChart.tsx` | `dataPoints[]` 形如 `标签:主值:副值:ratio` | [[Families/benchmark-chart]] | [[16 图片图库#benchmark-chart]] |
| `code` | `UltimateCodePanel.tsx` | `visual.props.lines[]` | [[Families/code]] | [[16 图片图库#code]] |

## 6. 视觉原子层

| 组件 | 位置 | 能力 | 当前用途 |
|---|---|---|---|
| `TextMaskWipe` | `src/components/visual-atoms/TextMaskWipe.tsx` | clip-path 文字揭示 | 文本擦除 / reveal |
| `GodRays` | `src/components/visual-atoms/GodRays.tsx` | 放射光束背景 | 聚焦 / 神性光感 |
| `DotGridParallax` | `src/components/visual-atoms/DotGridParallax.tsx` | 点阵视差背景 | 空间层次 / 节奏背景 |

这些不是 family，本质上是 family 可复用的视觉零件。
...
- `family 选错`：先看 `registry.ts` 和 [[15 命中规则与抢占地图]]
- `字段不进组件`：先看 `storyboardLoader.ts`
- `镜头没感觉`：先看 `shotGrammar.ts`、`CameraDirector.tsx`
- `字幕不对`：先看 `UltimateCaptionOverlay.tsx`
- `壳层太重或不该显示`：先看 `stageConfig` 和 `UltimatePlatformOverlay.tsx`

## 相关入口

- 选 family：[[13 Family视觉语法总表]]
- 看命中：[[15 命中规则与抢占地图]]
- 看图：[[16 图片图库]]
